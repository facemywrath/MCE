...
public enum Kit {
	...
	WIGHT(null, 3250, 7, Material.ICE, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(ItemManager.getItemByName("wight_sword").toItemStack()).addItem(new ItemStack(Material.COOKED_BEEF, 4)).getInventory()).getContents(), new ItemStack(Material.DIAMOND_HELMET, 1), new ItemStack(Material.CHAINMAIL_CHESTPLATE, 1), new ItemCreator(Material.LEATHER_LEGGINGS).setDyeColor(DyeColor.LIGHT_BLUE).getItem(), new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.LIGHT_BLUE).getItem(), null, null),
	MAGE(null, 3500, 8, Material.FIREBALL, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(ItemManager.getItemByName("mage_wand").toItemStack()).addItem(new ItemCreator(Material.WOOD_SWORD).addEnchant(Enchantment.KNOCKBACK, 1).addEnchant(Enchantment.DAMAGE_ALL, 1).getItem()).addItem(new ItemCreator(ItemManager.getItemByName("mage_bomb").toItemStack()).setAmount(5).getItem()).addItem(new ItemCreator(Material.POTION).setData((short) 8197).getItem()).getInventory()).getContents(), new ItemStack(Material.LEATHER_HELMET, 1), new ItemStack(Material.LEATHER_CHESTPLATE, 1), new ItemStack(Material.LEATHER_LEGGINGS, 1), new ItemStack(Material.LEATHER_BOOTS), null, null),
	TRICKSTER(null, 3500, 9, Material.GOLD_HOE, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.GOLD_HOE).addEnchant(Enchantment.KNOCKBACK, 1).addEnchant(Enchantment.DAMAGE_ALL, 1).getItem()).addItem(new ItemCreator(Material.BOW).getItem()).addItem(new ItemCreator(ItemManager.getItemByName("trickster_smoke").toItemStack()).setAmount(3).getItem()).addItem(new ItemStack(Material.COOKED_BEEF, 4)).addItem(new ItemStack(Material.ARROW, 1)).getInventory()).getContents(), new ItemStack(Material.CHAINMAIL_HELMET, 1), null, new ItemCreator(Material.LEATHER_LEGGINGS).setDyeColor(DyeColor.MAGENTA).getItem(), new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.MAGENTA).getItem(), null, new PotionEffect(PotionEffectType.SPEED, 100, 0)),
	UPGRADER(null, 3750, 10, Material.MAGENTA_GLAZED_TERRACOTTA, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.WOOD_SWORD).addEnchant(Enchantment.DAMAGE_ALL, 1).getItem()).addItem(new ItemStack(Material.COOKED_BEEF, 4)).getInventory()).getContents(), new ItemStack(Material.LEATHER_HELMET, 1), new ItemCreator(Material.LEATHER_CHESTPLATE).getItem(), new ItemCreator(Material.LEATHER_LEGGINGS).getItem(), new ItemCreator(Material.LEATHER_BOOTS).getItem(), null, null),
	HARPY("SKYLORD", 0, 11, Material.FEATHER, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.STONE_SWORD).addEnchant(Enchantment.KNOCKBACK, 1).getItem()).addItem(new ItemStack(Material.COOKED_BEEF, 4))).getInventory().getStorageContents(), new ItemCreator(Material.LEATHER_HELMET).setDyeColor(DyeColor.RED).getItem(), new ItemStack(Material.ELYTRA, 1), new ItemCreator(Material.LEATHER_LEGGINGS).setDyeColor(DyeColor.RED).getItem(), new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.RED).getItem(), null, new PotionEffect(PotionEffectType.JUMP, 100, 2)),
	GRAVITON("THISISSPARTA", 0, 12, Material.SHULKER_SHELL, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(ItemManager.getItemByName("graviton_sword").toItemStack()).addItem(new ItemCreator(Material.ENDER_PEARL).setAmount(3).setDisplayname("&5Gravbomb").addGlowing().getItem()).addItem(new ItemStack(Material.COOKED_BEEF, 3))).addItem(new ItemCreator(Material.SNOW_BALL).setDisplayname("&9Toggle Levitation On").getItem()).getInventory().getStorageContents(), new ItemCreator(Material.LEATHER_HELMET).setDyeColor(DyeColor.BLUE).getItem(), null, new ItemStack(Material.CHAINMAIL_LEGGINGS, 1), new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.BLUE).getItem(), null, new PotionEffect(PotionEffectType.SPEED, 100, 0)),
	SHADE("ASSASSINATE", 0, 13, Material.POTION, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.GOLD_SWORD).addEnchant(Enchantment.DAMAGE_ALL, 2).getItem())).getInventory().getStorageContents(), ItemCreator.getChameleonArmor("helmet"), ItemCreator.getChameleonArmor("chestplate"), ItemCreator.getChameleonArmor("leggings"), ItemCreator.getChameleonArmor("boots"), null, null),
	GUNNER("ARCHERY", 0, 14, Material.WOOD_PICKAXE, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(ItemManager.getItemByName("gunner_bow").toItemStack()).addItem(new ItemCreator(Material.WOOD_SWORD).addEnchant(Enchantment.KNOCKBACK, 2).getItem()).addItem(new ItemCreator(ItemManager.getItemByName("gunner_grenade").toItemStack()).setAmount(4).getItem()).addItem(new ItemStack(Material.COOKED_BEEF, 4)).getInventory()).getStorageContents(), new ItemCreator(Material.LEATHER_HELMET).setDyeColor(DyeColor.GRAY).getItem(), new ItemCreator(Material.LEATHER_CHESTPLATE).setDyeColor(DyeColor.GRAY).getItem(), new ItemStack(Material.CHAINMAIL_LEGGINGS, 1), new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.GRAY).getItem(), null, new PotionEffect(PotionEffectType.SPEED, 100, 0)),
	DEMON("HELLFIRE", 0, 15, Material.MAGMA, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.GOLD_SWORD).addEnchant(Enchantment.FIRE_ASPECT, 2).getItem()).getInventory()).getStorageContents(), new ItemStack(Material.GOLD_HELMET, 1), new ItemCreator(Material.LEATHER_CHESTPLATE).setDyeColor(DyeColor.RED).getItem(), null, new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.RED).getItem(), null, new PotionEffect(PotionEffectType.REGENERATION, 100, 1)),
	MASTER("MASTER", 0, 16, Material.BOOK, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.STONE_SWORD).addEnchant(Enchantment.KNOCKBACK, 2).getItem()).addItem(ItemManager.getItemByName("master_bow").toItemStack()).addItem(ItemManager.getItemByName("master_wand").toItemStack()).addItem(new ItemStack(Material.ARROW, 10))).getInventory().getStorageContents(), new ItemStack(Material.IRON_HELMET, 1), new ItemStack(Material.CHAINMAIL_CHESTPLATE, 1), new ItemStack(Material.CHAINMAIL_LEGGINGS, 1), new ItemStack(Material.CHAINMAIL_BOOTS, 1), null, new PotionEffect(PotionEffectType.REGENERATION, 100, 0));
