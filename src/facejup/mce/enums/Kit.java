...
public enum Kit {
	...
	GOBLIN(null, 4500, 11, Material.GOLD_NUGGET, Arrays.asList("&7The Goblin kit is very weak, with low", "&7armor and damage.", "&aTheft: Hitting a player can steal an item.", "&aShrink: Crouching makes you half-sized."), (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.WOOD_SWORD).getItem()).addItem(new ItemStack(Material.COOKED_BEEF, 2)).getInventory()).getContents(), null, null, null, null, null, null),
