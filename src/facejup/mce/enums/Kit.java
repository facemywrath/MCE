...
public enum Kit {
	...
	NONE(null, null, 0, 0, Material.BARRIER, Arrays.asList("&7Exit the queue"),null, null, null, null, null, null, null),
	RANDOM(null, null, 0, 1, Material.WATCH, Arrays.asList("&7Chooses a Random Kit of your kits"),null, null, null, null, null, null, null),
	WARRIOR("mindless", null, 0, 2, Material.IRON_SWORD, Arrays.asList("&7The Warrior kit is", "&7a balanced melee fighter class."), (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemStack(Material.IRON_SWORD, 1)).addItem(new ItemStack(Material.COOKED_BEEF, 4)).getInventory()).getContents(), new ItemStack(Material.LEATHER_HELMET, 1), new ItemStack(Material.IRON_CHESTPLATE, 1), new ItemStack(Material.CHAINMAIL_LEGGINGS, 1), null, null, null),
	ARCHER("qpo", null, 0, 3, Material.BOW, Arrays.asList("&7The Archer kit has low armor with", "&7decent ranged and melee damage."), (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.BOW).addEnchant(Enchantment.ARROW_INFINITE, 1).getItem()).addItem(new ItemCreator(Material.WOOD_SWORD).addEnchant(Enchantment.KNOCKBACK, 1).getItem()).addItem(new ItemStack(Material.COOKED_BEEF, 4)).addItem(new ItemStack(Material.ARROW, 1)).getInventory()).getContents(), new ItemStack(Material.LEATHER_HELMET, 1), new ItemStack(Material.CHAINMAIL_CHESTPLATE, 1), new ItemStack(Material.LEATHER_LEGGINGS, 1), new ItemStack(Material.LEATHER_BOOTS), null, null),
	...
	Kit(String disguiseName, String achcostname, int coincost, int slot, Material icon, List<String> description, ItemStack storage[], ItemStack helmet, ItemStack chestplate, ItemStack leggings, ItemStack boots, ItemStack offhand, PotionEffect potion)
	{
