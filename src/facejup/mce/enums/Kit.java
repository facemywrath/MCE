...
public enum Kit {
	...
	GRAVITON("THISISSPARTA", 0, 12, Material.SHULKER_SHELL, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(ItemManager.getItemByName("graviton_sword").toItemStack()).addItem(new ItemCreator(Material.ENDER_PEARL).setAmount(3).setDisplayname("&5Gravbomb").addGlowing().getItem()).addItem(new ItemStack(Material.COOKED_BEEF, 3))).getInventory().getStorageContents(), new ItemCreator(Material.LEATHER_HELMET).setDyeColor(DyeColor.BLUE).getItem(), null, new ItemStack(Material.CHAINMAIL_LEGGINGS, 1), new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.BLUE).getItem(), null, new PotionEffect(PotionEffectType.SPEED, 100, 0)),
	...
	DEMON("HELLFIRE", 0, 15, Material.MAGMA, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.GOLD_SWORD).addEnchant(Enchantment.FIRE_ASPECT, 2).getItem()).getInventory()).getStorageContents(), new ItemStack(Material.GOLD_HELMET, 1), new ItemCreator(Material.LEATHER_CHESTPLATE).setDyeColor(DyeColor.RED).getItem(), new ItemStack(Material.GOLD_LEGGINGS, 1), new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.RED).getItem(), null, new PotionEffect(PotionEffectType.REGENERATION, 100, 1)),
