...
public enum Kit {
	...
	DEMON("HELLFIRE", 0, 11, Material.MAGMA, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.GOLD_SWORD).addEnchant(Enchantment.FIRE_ASPECT, 2).getItem()).getInventory()).getStorageContents(), new ItemStack(Material.GOLD_HELMET, 1), new ItemCreator(Material.LEATHER_CHESTPLATE).setDyeColor(DyeColor.RED).getItem(), new ItemStack(Material.GOLD_LEGGINGS, 1), new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.RED).getItem(), null, new PotionEffect(PotionEffectType.REGENERATION, 100, 1)),
	MASTER("MASTER", 0, 12, Material.BOOK, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.STONE_SWORD).addEnchant(Enchantment.KNOCKBACK, 2).getItem()).addItem(ItemManager.getItemByName("master_bow").toItemStack()).addItem(ItemManager.getItemByName("master_wand").toItemStack()).addItem(new ItemStack(Material.ARROW, 10))).getInventory().getStorageContents(), new ItemStack(Material.IRON_HELMET, 1), new ItemStack(Material.CHAINMAIL_CHESTPLATE, 1), new ItemStack(Material.CHAINMAIL_LEGGINGS, 1), new ItemStack(Material.CHAINMAIL_BOOTS, 1), null, new PotionEffect(PotionEffectType.REGENERATION, 100, 0));
