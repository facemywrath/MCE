...
public enum Kit {
	...
	MAGE(null, 3500, 7, Material.FIREBALL, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.WOOD_SWORD).addEnchant(Enchantment.KNOCKBACK, 1).addEnchant(Enchantment.DAMAGE_ALL, 1).getItem()).addItem(ItemManager.getItemByName("mage_wand").toItemStack()).addItem(new ItemCreator(Material.POTION).setData((short) 8197).getItem()).addItem(new ItemStack(Material.GOLDEN_APPLE, 1)).getInventory()).getContents(), new ItemStack(Material.LEATHER_HELMET, 1), new ItemStack(Material.LEATHER_CHESTPLATE, 1), new ItemStack(Material.LEATHER_LEGGINGS, 1), new ItemStack(Material.LEATHER_BOOTS), null, null),
	...
	GRAVITON("THISISSPARTA", 0, 9, Material.SHULKER_SHELL, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(ItemManager.getItemByName("graviton_sword").toItemStack()).addItem(new ItemCreator(Material.ENDER_PEARL).setAmount(4).setDisplayname("&5Gravbomb").addGlowing().getItem()).addItem(new ItemStack(Material.COOKED_BEEF,4))).getInventory().getStorageContents(), new ItemCreator(Material.LEATHER_HELMET).setDyeColor(DyeColor.BLUE).getItem(), new ItemStack(Material.CHAINMAIL_CHESTPLATE, 1), new ItemStack(Material.CHAINMAIL_LEGGINGS, 1), new ItemCreator(Material.LEATHER_BOOTS).setDyeColor(DyeColor.BLUE).getItem(), null, new PotionEffect(PotionEffectType.SPEED, 100, 0)),
	SHADE("ASSASSINATE", 0, 10, Material.POTION, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.GOLD_SWORD).addEnchant(Enchantment.DAMAGE_ALL, 2).getItem()).addItem(new ItemStack(Material.COOKED_BEEF, 4))).getInventory().getStorageContents(), ItemCreator.getChameleonArmor("helmet"), ItemCreator.getChameleonArmor("chestplate"), ItemCreator.getChameleonArmor("leggings"), ItemCreator.getChameleonArmor("boots"), null, null),
	MASTER("MASTER", 0, 11, Material.BOOK, (new InventoryBuilder(null, InventoryType.PLAYER).addItem(new ItemCreator(Material.STONE_SWORD).addEnchant(Enchantment.KNOCKBACK, 2).getItem()).addItem(ItemManager.getItemByName("master_bow").toItemStack()).addItem(ItemManager.getItemByName("master_wand").toItemStack()).addItem(new ItemStack(Material.ARROW, 10))).getInventory().getStorageContents(), new ItemStack(Material.IRON_HELMET, 1), new ItemStack(Material.CHAINMAIL_CHESTPLATE, 1), new ItemStack(Material.CHAINMAIL_LEGGINGS, 1), new ItemStack(Material.CHAINMAIL_BOOTS, 1), null, new PotionEffect(PotionEffectType.REGENERATION, 100, 0));
