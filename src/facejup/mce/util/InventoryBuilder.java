...
public class InventoryBuilder {
	...
	public static Inventory createKitInventory(Player player)
	{
		...
		ItemStack none = new ItemCreator(Material.BARRIER).setDisplayname((kit == Kit.NONE)?"&6Kit: None":"&2Kit: None").setLore(Arrays.asList((kit == Kit.NONE?"&7&lThis is your kit":""))).getItem();
